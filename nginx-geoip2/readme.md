...
| Código-fonte | `https://github.com/lzocateli/containers/tree/main/nginx-geoip2` |
| Documentação | `https://github.com/lzocateli/containers/tree/main/nginx-geoip2` |
...
docker buildx build --dry-run nginx-geoip2

# Build local sem cache
docker build --no-cache -t test-geoip nginx-geoip2
